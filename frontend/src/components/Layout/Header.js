    ...
    <>
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <Link to="/" className={brandClasses}>
              <img src={web}  width={50} height={50} style={{borderRadius:'70%',marginRight:'3px'}}/>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" style={{ marginLeft: '460px' }}>
            {/* <ul className="nav  ml-auto" style={{ paddingLeft: '350px' }}> */}
