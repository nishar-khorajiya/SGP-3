...
// }
  ...
  const navbarClassesAuth = auth.token ? 'navbar navbar-expand-lg bg-body-tertiary logged-in' : 'navbar navbar-expand-lg bg-body-tertiary logged-out';
  const brandClassesAuth = auth.token ? 'navbar-brand logged-in' : 'navbar-brand logged-out';
  ...
  return (
    <>
      ...
      <nav className={navbarClassesAuth}>
        <div className="container-fluid">
          <button
            className="navbar-toggler"
            type="button"
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
            <Link to="/" className={brandClassesAuth}><img src={web} style={{height: "50px", width: "50px", borderRadius: "70%",marginRight:"3px"}}/>Ashutosh Enterprise</Link>
            <ul className="nav nav-pills ml-auto" style={{ paddingLeft: "350px" }}>
              <li className="nav-item">
                <NavLink to="/" className="nav-link" aria-current="page">
                  Home
